...
const field = new Field(
  ...
  "block overflow-x-auto [&::-webkit-scrollbar]:hidden min-h-[3.265rem] p-4 focus:outline-none max-w-full bg-(--nya-bg0 rounded mt-8 mx-auto w-96 [&.\\!bg-transparent]:!bg-(--nya-bg)",
)
