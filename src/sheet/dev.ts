...
expr`\tyname{polygon}\operatorname{vector}\left(\left(-1,-.5\right),\left(-.5,1\right)\right)`
...
expr`F=\operatorname{line}\left(A.point,C.point\right)`
expr`glider\left(F,.3\right)`
expr`q_2=0.1base2`
