import "../../index.css"
import { exts, options } from "./defaults"
import { Field } from "./field"
import { h } from "./jsx"
import type { Dir, VDir } from "./model"
...
export class MyField extends Field {
  ...
  onDelOut(towards: Dir): void {
    console.log("del out ", towards)
  }

  onMoveOut(towards: Dir): void {
    console.log("move out ", towards)
  }
