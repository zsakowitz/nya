...
function secFunctions2(sheet: Sheet, _list: PackageList, _named: boolean) {
  ...
  const raw = Object.values(FNS)
  const USED =
    "abs:33; and:17; arccos:13; arccot:11; arccsc:11; arcsec:11; arcsin:13; arctan:30; arg:2; binomialdist:54; ceil:2; cmp:3; complex:37; component:0; conj:38; construct point:5; corr:39; cos:10; cot:8; count:16; cov:35; covp:36; csc:8; debugpoint:36; dot:17; elappearance:50; elblock:33; elboil:34; elcategory:47; elconfig:40; elconfigshort:46; eldescription:319; eldiscoveredby:61; eleaffinity:65; elenegativity:30; elmelt:36; elmolarheat:79; elname:38; elnamedby:43; elnumber:22; elperiod:22; elphase:37; elsymbol:35; exp:37; floor:2; forceshader:18; fract:2; hsv:71; imag:13; in:40; intosi:75; join:100; juxtapose:249; ln:27; log:30; log with subscript:9; mad:27; mass:34; max:35; mean:17; median:41; min:35; mod:2; normaldist:74; or:15; plot:161; point:35; poissondist:16; quantile:3; quartile:2; ranks:35; real:31; rgb:91; round:4; screendistance:28; sec:8; sign:38; sin:10; sort:27; spearman:39; stats:18; stdev:32; stdevp:33; tan:8; tdist:68; text:164; total:17; uniformdist:100; unique:35; unsign:73; valid:77; var:28; varp:29; +:101; +:86; -:85; -:72; .x:9; .y:9; <:10; =:11; >:11; ·:249; ×:10; ÷:197; ↑:97; ≠:14; ≤:14; ≥:15; ≮:17; ≯:15; ≰:16; ≱:15; ⊙:81".split(
      "; ",
    )
  const fns = ALL_DOCS
