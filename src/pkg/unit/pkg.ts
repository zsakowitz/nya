  ...
  docs: {
    units() {
      return [
        ...
        example("(20unitdegC)inunitdegF", "=68\\wordvar{°F}"),
        ...
        px`Since ${b("C")} and ${b("F")} are used for coulomb and farad, respectively, use ${b("degC")} and ${b("degF")} for celsius and fahrenheit.`,
    ...
    "units (temperature)"() {
      return [
        px`First: since ${b("C")} and ${b("F")} are used for coulomb and farad, respectively, use ${b("degC")} and ${b("degF")} for celsius and fahrenheit.`,
        ...
        px`These units therefore come in two variants. The regular ${b("degC")} and ${b("degF")} units are used for measured temperature, and ${b("deltacelsius")} and ${b("deltafahrenheit")} (short form: ${b("dC")} or ${b("dF")}) are used for changes in temperature.`,
        ...
        example(
          "2 unit degC + ((3 unit degC) in unit K)",
          "=278.15 \\wordvar{°C}",
        ),
        example("2 unit degC + 3 unit dC", "=5 \\wordvar{°C}"),
        ...
        example(
          "\\frac{5 unit J}{(3 unit degC) in unit K}",
          "=0.01810610176\\frac\\wordvar J\\wordvar K",
        ),
        example(
          "\\frac{5 unit J}{3 unit dC}",
        ...
        example(
          "2 unit degC \\cdot ((3 unit degC) in unit K)",
          "=552.3 \\wordvar{°C}\\cdot\\wordvar K",
        ),
        example(
          "2 unit degC \\cdot 3 unit dC",
