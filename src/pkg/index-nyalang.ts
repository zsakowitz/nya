export const NYALANG_PACKAGES_BUILTIN = {
  ...
  "nya:2d/geo/complex": ()=>Promise.resolve({default:{"name":"complex 2D geometry","label":"<TODO: no label>","category":"auto-generated (nyalang)","deps":[],"scripts":["2d/geo/complex"]} as const}),
